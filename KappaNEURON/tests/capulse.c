...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_capulse", _hoc_setdata,
 "KTF_capulse", _hoc_KTF,
 "efun_capulse", _hoc_efun,
 "ghk_capulse", _hoc_ghk,
 0, 0
};
#define KTF KTF_capulse
#define efun efun_capulse
#define ghk ghk_capulse
